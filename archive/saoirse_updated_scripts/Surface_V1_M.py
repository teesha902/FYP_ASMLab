...
for f in csv_files:
    ...
    file_location_raw= ('/Users/saoirselightbourne/Desktop/KF_SUMMER_2022/Raw_CSVs/d77/d77_'+name+folder+'.csv')
    csv_RAW = pd.read_csv(file_location_raw)
    exp_time =int(csv_RAW.iloc[0,22])
    exp_time_string= str(exp_time)+'s'

    raw_csv=pd.read_csv('/Users/saoirselightbourne/Desktop/KF_SUMMER_2022/Raw_CSVs/d77/Cropped_CSV_d77/d77_'+name+folder+'_Raw_INTER_MM.csv')
    led_csv=pd.read_csv('/Users/saoirselightbourne/Desktop/KF_SUMMER_2022/Raw_CSVs/d77/Cropped_CSV_d77/d77_'+name+folder+'_12S_INTER_MM.csv')
    ...
    writer = pd.ExcelWriter('/Users/saoirselightbourne/Desktop/KF_SUMMER_2022/KilliFish_Analysis_Output/Output_Melodi/Surface/'+d77+name+folder+'.xlsx')
    ...
    book = openpyxl.load_workbook('/Users/saoirselightbourne/Desktop/KF_SUMMER_2022/KilliFish_Analysis_Output/Output_Melodi/Surface/'+d77+name+folder+'.xlsx')
    sheet = book.active
    rows = frames
    sheet.append(rows)
    book.save('/Users/saoirselightbourne/Desktop/KF_SUMMER_2022/KilliFish_Analysis_Output/Output_Melodi/Surface/'+d77+name+folder+'.xlsx')
