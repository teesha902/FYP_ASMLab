...
import glob
import os
folder_name= 'd77'# could be d 77 etc
path = ('/Users/saoirselightbourne/Desktop/KF_SUMMER_2022/Raw_CSVs/'+folder_name)
...
for f in csv_files:
    ...
    file_location_raw= ('/Users/saoirselightbourne/Desktop/KF_SUMMER_2022/Raw_CSVs/'+folder_name+'/'+folder_name+'_'+name+folder+'.csv')
    ...
    file_location= ('/Users/saoirselightbourne/Desktop/KF_SUMMER_2022/Raw_CSVs/'+folder_name+'/Cropped_CSV_'+folder_name+'/'+folder_name+'_'+name+folder+'_3S_INTER_MM.csv')
    csv_3 = pd.read_csv(file_location)
    
    
    
    #Read in 12 second CSV file
    file_location_12= ('/Users/saoirselightbourne/Desktop/KF_SUMMER_2022/Raw_CSVs/'+folder_name+'/Cropped_CSV_'+folder_name+'/'+folder_name+'_'+name+folder+'_12S_INTER_MM.csv')
    csv_12 = pd.read_csv(file_location_12)
    
    
    #Read in original csv file
    file_location_og= ('/Users/saoirselightbourne/Desktop/KF_SUMMER_2022/Raw_CSVs/'+folder_name+'/'+folder_name+'_'+name+folder+'.csv')
    ...
    writer_raw = pd.ExcelWriter('/Users/saoirselightbourne/Desktop/KF_SUMMER_2022/KilliFish_Analysis_Output/Output_Melodi/Dist_Ac_Vel/'+folder_name+'_'+name+folder+'.xlsx')
    ...
    writer = pd.ExcelWriter('/Users/saoirselightbourne/Desktop/KF_SUMMER_2022/KilliFish_Analysis_Output/Output_Melodi/Descriptive_Data/'+folder_name+'_'+name+folder+'.xlsx')
